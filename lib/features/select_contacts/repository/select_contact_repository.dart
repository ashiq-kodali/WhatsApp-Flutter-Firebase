...
import 'package:whatsapp_clone_firebase/features/chat/screens/mobile_chat_screen.dart';
...
class SelectContactRepository {
  ...
  void selectContact(Contact selectedContact,BuildContext context )async{
    try {
      ...
      if(!isFound){
        showSnackBar(context: context, content: '${selectedContact.displayName} does not exist on this app');
      }
    } catch (e) {
