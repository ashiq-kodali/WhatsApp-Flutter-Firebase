...
import 'package:whatsapp_clone_firebase/features/chat/controller/chat_controller.dart';

class BottomChatField extends ConsumerStatefulWidget {
  final recieverUserId;
  const BottomChatField({
    super.key,required this.recieverUserId
  });
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        CircleAvatar(
          radius: 25,
          backgroundColor: const Color(0xff128C73E),
